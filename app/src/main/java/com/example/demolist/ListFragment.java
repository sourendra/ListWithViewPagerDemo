 ...
 */
public class ListFragment extends Fragment implements QuestionListAdapter.OnListItemClickListener{
    ...
    public static ListFragment newInstance(ArrayList<Question> questionList) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new QuestionListAdapter(questionList, this::onItemClick);
        rv_question_list.setAdapter(adapter);
        return view;
    }
